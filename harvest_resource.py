#!/usr/bin/env python3
"""
harvest_resource.py — the resource wire: who creates money, who lends it, who
sets the rules attached to it, and who ends up holding the land, the harvest,
the water and the route.

After Part 1(a) of Suppression, "Control of Physical Resources", and its six
subsections: money creation on the national scale, its flow downstream, the
same on the international scale, its flow, "globalization", and a way forward.

The wire refuses a sector on its own. A story about copper output or freight
rates is not this subject; a story about who was awarded the concession, what
was pledged against the loan, or who may now sail through the strait, is. Every
subject term carries the control words it must appear beside.

    python3 harvest_resource.py
    python3 harvest_resource.py --dry-run
    python3 harvest_resource.py --fixtures DIR
"""
...
SOURCES_PATH = os.path.join(HERE, "sources_resource.json")
OUT_PATH = os.path.join(HERE, "wire_resource.json")
...
# --------------------------------------------------------------------------
# --------------------------------------------------------------------------
# Subjects — after Part 1(a) of Suppression: control of resources.
#
...
TOPICS = [
    ("creation", "Money creation", [
        ("central bank", ["money supply", "balance sheet", "quantitative easing", "reserve requirement",
                          "money creation", "seigniorage", "prints", "printing", "monetary base"]),
        ("federal reserve", []), ("fed", ["rate", "balance sheet", "policy", "chair", "meeting"]),
        ("european central bank", []), ("ecb", []), ("bank of england", []),
        ("bank of japan", []), ("boj", []), ("pboc", []), ("reserve bank of india", []),
        ("balance sheet", ["central bank", "fed", "runoff", "expansion", "shrink"]),
        ("quantitative easing", []), ("money supply", []), ("fractional reserve", []),
        ("full reserve", []), ("monetary base", []), ("seigniorage", []), ("money printing", []),
        ("debasement", []), ("currency debasement", []),
        ("inflation", ["money supply", "money printing", "central bank", "debasement", "purchasing power"]),
    ]),
    ("credit", "Credit, rates and the shadow system", [
        ("interest rate", ["central bank", "decision", "hike", "cut", "policy", "hold", "fed",
                           "holds", "raised", "lowered"]),
        ("interest rates", ["central bank", "decision", "hike", "cut", "policy", "hold", "fed",
                            "holds", "raised", "lowered"]),
        ("policy rate", []), ("discount window", []), ("bailout", []), ("bail-out", []),
        ("shadow bank", []), ("shadow banking", []), ("repo market", []), ("repurchase agreement", []),
        ("securitisation", []), ("securitization", []), ("derivative", ["bank", "exposure", "market", "risk"]),
        ("collateral", ["loan", "bank", "central bank", "pledged"]),
        ("insider trading", []), ("front running", []), ("front-running", []), ("dark pool", []),
        ("high-frequency trading", []), ("market manipulation", []),
        ("reinsurance", ["risk", "market", "concentration"]), ("systemically important", []),
        ("too big to fail", []), ("bank consolidation", []), ("bank merger", []),
    ]),
    ("reserves", "Reserves and imbalances", [
        ("special drawing rights", []), ("sdr allocation", []), ("swap line", []),
        ("capital control", []), ("capital controls", []), ("currency peg", []), ("pegged currency", []),
        ("foreign exchange reserves", []), ("reserve accumulation", []), ("reserve currency", []),
        ("dollar hegemony", []), ("de-dollarisation", []), ("de-dollarization", []),
        ("current account", ["deficit", "surplus", "imbalance"]),
        ("global imbalances", []), ("triffin", []), ("petrodollar", []),
        ("eurodollar", []), ("offshore dollar", []),
    ]),
    ("debt", "Sovereign debt and conditionality", [
        ("imf", ["loan", "programme", "program", "conditionality", "austerity", "bailout",
                 "staff-level", "tranche", "review", "arrears"]),
        ("international monetary fund", []), ("world bank", ["loan", "credit", "project", "conditionality"]),
        ("structural adjustment", []), ("conditionality", []), ("austerity", []),
        ("sovereign debt", []), ("debt distress", []), ("debt restructuring", []),
        ("debt relief", []), ("debt moratorium", []), ("default", ["debt", "bond", "sovereign", "payment"]),
        ("paris club", []), ("common framework", []), ("vulture fund", []),
        ("odious debt", []), ("debt sustainability", []), ("arrears", ["debt", "payment", "creditor"]),
    ]),
    ("lending", "Bilateral and undisclosed lending", [
        ("bilateral loan", []), ("bilateral lender", []), ("bilateral creditor", []),
        ("resource-backed loan", []), ("resource-backed loans", []), ("resource backed lending", []),
        ("collateralised", ["loan", "oil", "mineral", "export", "revenue", "sovereign"]),
        ("collateralized", ["loan", "oil", "mineral", "export", "revenue", "sovereign"]),
        ("collateralised loan", ["sovereign", "state", "government"]),
        ("hidden debt", []), ("undisclosed loan", []), ("undisclosed debt", []),
        ("underreported", ["finance", "lending", "flows", "debt"]),
        ("debt-for-equity", []), ("debt-for-nature", []), ("debt swap", []),
        ("belt and road", []), ("export credit", []), ("export-import bank", []),
        ("china development bank", []), ("aiddata", []), ("concessional loan", []),
    ]),
    ("gatekeeping", "Ratings and gatekeeping", [
        ("credit rating", ["sovereign", "downgrade", "upgrade", "outlook", "agency"]),
        ("downgrade", ["sovereign", "rating", "outlook", "debt"]),
        ("moody", ["rating", "sovereign"]), ("s&p global ratings", []), ("fitch ratings", []),
        ("correspondent banking", []), ("de-risking", ["bank", "correspondent", "remittance"]),
        ("swift", ["access", "cut off", "excluded", "network", "payment"]),
        ("sanctions", ["asset", "freeze", "designation", "financial", "bank", "export"]),
        ("asset freeze", []), ("payment rail", []), ("clearing house", ["access", "control"]),
        ("financial exclusion", []), ("blacklist", ["financial", "tax", "jurisdiction"]),
    ]),
    ("traderule", "Trade rule", [
        ("wto", []), ("world trade organization", []), ("world trade organisation", []),
        ("tariff", ["imposed", "raised", "dispute", "retaliation", "exemption"]),
        ("trade agreement", []), ("free trade agreement", []), ("trade dispute", []),
        ("dispute settlement", []), ("anti-dumping", []), ("countervailing", []),
        ("export ban", []), ("export licence", []), ("export license", []), ("export restriction", []),
        ("import quota", []), ("local content", []), ("trade quota", []),
        ("most favoured nation", []), ("trade preference", []),
    ]),
    ("investorrights", "Investor rights over law", [
        ("isds", []), ("investor-state", []), ("investor state dispute", []),
        ("icsid", []), ("arbitral tribunal", ["investment", "investor", "state"]),
        ("bilateral investment treaty", []), ("investment treaty", []),
        ("regulatory chill", []), ("stabilisation clause", []), ("stabilization clause", []),
        ("energy charter treaty", []), ("arbitration award", ["state", "government", "investor"]),
    ]),
    ("enclosure", "Intellectual property as enclosure", [
        ("patent", ["seed", "medicine", "drug", "variety", "gene", "licence", "royalty", "monopoly"]),
        ("trips", ["agreement", "waiver", "patent"]), ("upov", []), ("plant variety", []),
        ("plant breeders rights", []), ("seed law", []), ("seed patent", []),
        ("compulsory licence", []), ("compulsory license", []), ("evergreening", []),
        ("intellectual property", ["enforcement", "royalty", "monopoly", "licence", "dispute"]),
    ]),
    ("land", "Land and title", [
        ("land grab", []), ("land grabbing", []), ("land concession", []), ("land acquisition", []),
    ...
    ("ground", "Who holds the ground", [
        ("mining concession", []), ("mining licence", []), ("mining license", []),
        ("licensing round", []), ("production sharing", []), ("exploration permit", []),
        ("royalties", ["mining", "oil", "gas", "mineral", "state", "government"]),
        ("nationalisation", ["mine", "oil", "gas", "mineral", "resource", "industry"]),
        ("nationalization", ["mine", "oil", "gas", "mineral", "resource", "industry"]),
        ("mineral rights", []), ("extractive", ["contract", "revenue", "transparency", "concession"]),
        ("mine", ["concession", "licence", "license", "permit", "auction", "contract", "takeover"]),
        ("lithium", ["concession", "contract", "licence", "nationalis", "nationaliz", "deal", "control"]),
        ("cobalt", ["concession", "contract", "licence", "control", "supply deal"]),
        ("rare earth", ["export", "control", "concession", "supply", "restriction"]),
        ("oil block", []), ("gas field", ["licence", "concession", "contract", "award"]),
        ("resource contract", []), ("resource nationalism", []),
        ("concession", ["copper", "gold", "iron", "bauxite", "nickel", "uranium", "coal",
                        "oil", "gas", "mineral", "mining", "quarry", "timber", "forest"]),
        ("copper", ["concession", "licence", "license", "contract", "auction", "nationalis",
                    "nationaliz", "royalt", "stake", "takeover"]),
        ("nickel", ["concession", "licence", "contract", "export ban", "nationalis", "control"]),
        ("uranium", ["concession", "licence", "contract", "nationalis", "control", "supply deal"]),
        ("bauxite", ["concession", "licence", "contract", "nationalis", "export ban"]),
        ("gold", ["concession", "licence", "mining contract", "nationalis", "royalt", "permit"]),
        ("timber", ["concession", "licence", "permit", "logging rights"]),
        ("auctioned", ["block", "concession", "licence", "acreage", "mineral", "oil", "gas"]),
    ]),
    ("harvest", "Who controls the harvest", [
        ("seed", ["patent", "law", "monopoly", "certified", "saving", "royalty", "corporate", "control"]),
        ("farmland", ["acquisition", "purchase", "investor", "fund", "foreign", "grab"]),
        ("contract farming", []), ("outgrower", []),
        ("fertiliser", ["price", "monopoly", "supply", "control", "export ban"]),
        ("fertilizer", ["price", "monopoly", "supply", "control", "export ban"]),
        ("fisheries", ["access agreement", "licence", "quota", "foreign fleet", "rights"]),
        ("fishing rights", []), ("food speculation", []), ("commodity speculation", []),
        ("grain", ["export ban", "trader", "stockpile", "hoarding", "cartel", "reserve"]),
        ("agribusiness", ["consolidation", "merger", "monopoly", "control"]),
        ("cargill", []), ("bayer", ["seed", "patent", "monsanto"]), ("monsanto", []),
        ("input dependency", []), ("food sovereignty", []),
    ]),
    ("water", "Water and utilities", [
        ("water privatisation", []), ("water privatization", []), ("water rights", []),
        ("water concession", []), ("aquifer", ["rights", "depletion", "permit", "extraction", "control"]),
        ("riparian", []), ("utility privatisation", []), ("utility privatization", []),
        ("remunicipalisation", []), ("remunicipalization", []),
    ...
    ("route", "Who controls the route", [
        ...
        ("strait", ["closure", "blockade", "control", "transit", "traffic halted"]),
        ("canal", ["transit", "toll", "control", "restriction", "queue"]),
        ("shipping lane", []), ("sea lane", []), ("cabotage", []), ("flag of convenience", []),
        ("port", ["concession", "lease", "acquired", "stake", "operator", "control", "ownership"]),
        ("logistics", ["control", "monopoly", "acquisition", "chokehold"]),
        ("strategic reserve", []), ("stockpile", ["strategic", "national", "release"]),
        ("supply chain", ["control", "chokepoint", "dependency", "leverage"]),
    ]),
    ("digital", "Money made digital", [
        ("cbdc", []), ("central bank digital currency", []), ("digital currency", ["central bank", "state", "pilot", "rollout"]),
        ("programmable money", []), ("tokenised deposit", []), ("tokenized deposit", []),
        ("stablecoin", ["regulation", "reserve", "issuer", "control"]),
        ("digital identity", ["payment", "wallet", "financial"]),
        ("carbon credit", []), ("carbon offset", []), ("carbon market", []),
    ]),
    ("secrecy", "Secrecy and who is allowed to hide", [
        ("tax haven", []), ("secrecy jurisdiction", []), ("secrecy jurisdictions", []), ("financial secrecy", []),
        ("tax havens", []),
        ("beneficial ownership", []), ("shell company", []), ("shell companies", []),
        ("transfer pricing", []), ("profit shifting", []), ("base erosion", []),
        ("illicit financial flows", []), ("offshore", ["account", "company", "trust", "leak", "wealth", "jurisdiction"]),
        ("bank secrecy", []), ("beneficial owner", []), ("nominee director", []),
        ("free port", ["storage", "art", "wealth"]), ("golden passport", []), ("golden visa", []),
    ]),
    ("wayout", "Universal Income and the way out", [
        ("universal basic income", []), ("basic income", ["pilot", "trial", "scheme", "programme", "proposal"]),
        ("unconditional cash transfer", []), ("guaranteed income", []),
        ("public bank", []), ("public banking", []), ("state bank", ["public", "founded", "proposal"]),
        ("debt cancellation", []), ("debt jubilee", []), ("debt audit", []),
        ("resource sovereignty", []), ("food sovereignty", []), ("energy sovereignty", []),
        ("cooperative", ["worker", "farmer", "housing", "energy", "movement"]),
        ("community land trust", []), ("commons management", []), ("participatory budgeting", []),
        ("sovereign wealth fund", ["citizens", "dividend", "distribution"]),
    ]),
]

ANCHOR = [
    # A story qualifies on CONTROL language, never on a sector alone. The
    # subject table above carries the sector pairs; this is the shorter set of
    # terms that are control language wherever they appear.
    "central bank", "money supply", "quantitative easing", "fractional reserve",
    "sovereign debt", "debt restructuring", "structural adjustment", "conditionality",
    "austerity", "imf", "international monetary fund", "world bank", "paris club",
    "resource-backed", "hidden debt", "undisclosed loan", "bilateral creditor",
    "credit rating", "correspondent banking", "de-risking", "swift", "asset freeze",
    "wto", "world trade organization", "world trade organisation", "tariff",
    "trade agreement", "dispute settlement", "export ban", "export licence", "local content",
    "isds", "investor-state", "icsid", "investment treaty", "regulatory chill",
    "trips", "upov", "plant variety", "compulsory licence", "seed patent", "seed law",
    "land grab", "land concession", "expropriation", "land titling", "cadastre",
    "special economic zone", "enclosure", "customary land",
    "concession", "licensing round", "production sharing", "royalties", "mineral rights",
    "nationalisation", "nationalization", "resource nationalism", "extractive",
    "contract farming", "food sovereignty", "fishing rights", "outgrower",
    "privatisation", "privatization", "remunicipalisation", "water rights",
    "port concession", "chokepoint", "cabotage", "flag of convenience", "strategic reserve",
    "cbdc", "central bank digital currency", "programmable money", "carbon market",
    "tax haven", "tax havens", "secrecy jurisdiction", "secrecy jurisdictions",
    "beneficial ownership", "shell company", "shell companies", "financial secrecy",
    "transfer pricing", "profit shifting", "illicit financial flows",
    "universal basic income", "basic income", "public banking", "debt cancellation",
    "debt jubilee", "odious debt", "resource sovereignty", "sovereign wealth fund",
    "special drawing rights", "swap line", "capital controls", "currency peg",
    "reserve currency", "dollar hegemony", "de-dollarisation", "global imbalances",
    "shadow banking", "repo market", "securitisation", "bailout", "insider trading",
    "front running", "vulture fund", "debt-for-equity", "debt-for-nature",
]

BLOCK = [
    # careers, appointments and tributes at the institutions this wire follows.
    # A World Bank job advert is not the World Bank as a subject.
    "job", "vacancy", "internship", "fully funded programme", "fully funded program",
    "scholarship", "fellowship application", "career", "recruitment drive",
    "completes prestigious", "executive leadership programme", "leadership program",
    "obituary", "tribute to", "friend of the philippines", "appointed as",
    # the same words in their market-report sense: price, output, earnings. This
    # wire is about who holds the thing, not what it sold for this morning.
    "share price", "stock rose", "stock fell", "shares jumped", "shares slipped",
    "quarterly earnings", "earnings beat", "earnings miss", "profit rose", "profit fell",
    "analyst rating", "price target", "buy rating", "sell rating", "outperform",
    "dividend announced", "share buyback", "ipo priced", "market close", "closing bell",
    "output rose", "output fell", "production rose", "production fell", "production target",
    "crop forecast", "harvest forecast", "yield forecast", "freight rate", "charter rate",
    "spot rate", "bunker price", "how to invest", "investment tips", "portfolio idea",
    "stock pick", "best stocks", "crypto price", "bitcoin price", "token rally",
    # metaphor
    "political capital", "social capital", "capital city", "goldmine of", "gold mine of",
    "land of opportunity", "aborted",
]
...
#
# The single largest thing the run loop's default was swallowing was the one
# the section opens on: who lends, on what condition, and what a country gives
# up to accept it. A refusal of an IMF offer ran six times in Indonesian across
# one week and matched nothing each time, because "lending" was written in
# English and in the vocabulary of documents rather than of news.
# --------------------------------------------------------------------------
LOCAL_TERMS = {
    "lending": [
        ("imf", ["loan", "lending", "deal", "programme", "program", "package", "offer",
                 "financing", "bailout", "tranche", "reject", "refuse"]),
        ("world bank", ["loan", "guarantee", "financing", "credit", "backed", "programme", "program"]),
        ("pinjaman", None), ("utang", ["imf", "bank dunia", "luar negeri", "memangkas"]),
        ("tawaran pinjaman", None), ("tolak pinjaman", None), ("tolak utang", None),
        ("financing deal", None), ("credit line", None), ("standby arrangement", None),
        ("bailout", None), ("guarantee*", ["world bank", "sovereign", "loan", "unlock"]),
        ("empréstimo", None), ("préstamo", ["fmi", "banco mundial"]),
        ("prêt", ["fmi", "banque mondiale"]), ("kredit", ["imf", "weltbank"]),
        ("кредит", ["мвф", "всемирн"]), ("借款", None), ("融资", ["世行", "国际货币基金"]),
        ("차관", None), ("قرض", ["صندوق النقد", "البنك الدولي"]),
        ("ऋण", ["आईएमएफ", "विश्व बैंक"]), ("ঋণ", ["আইএমএফ", "বিশ্বব্যাংক"]),
        ("imf", ["融資", "支援", "プログラム"]), ("国際通貨基金", None),
    ],
    "reserves": [
        ("gold buying", None), ("gold reserves", None), ("central bank gold", None),
        ("cadangan kas", None), ("cadangan devisa", None), ("foreign reserves", None),
        ("reservas", ["banco central", "divisas", "oro"]), ("外汇储备", None),
        ("золотовалютн", None), ("金準備", None), ("altın rezerv", None),
    ],
    "creation": [
        ("central bank governor", None), ("central bank chief", None), ("central bank head", None),
        ("中銀総裁", None), ("gubernur bank sentral", None), ("banco central", ["presidente", "governador"]),
        ("independence", ["central bank", "monetary"]), ("g20 finance ministers", None),
        ("financial stability board", None), ("fsb chair", None),
    ],
    "traderule": [
        ("tariff*", ["hike*", "raise*", "talks", "discuss", "impose*", "trade"]),
        ("tarif", ["naik", "impor", "dagang"]), ("arancel*", None), ("关税", None),
        ("関税", None), ("тариф", ["торгов", "пошлин"]),
    ],
    "gatekeeping": [
        ("electricity meter*", None), ("power tariff", None), ("electricity tariff", None),
        ("prepaid meter*", None), ("connection fee*", ["electricity", "water", "grid"]),
        ("tarif listrik", None), ("tarifa eléctrica", None), ("电价", None),
        ("lng import*", None), ("tax concession", ["lng", "gas", "mining"]),
        ("nationalisation", None), ("nationalization", None), ("privatis*", ["utility", "water", "grid"]),
    ],
    "harvest": [
        ("royalt*", ["mining", "mineral", "oil", "gas", "timber"]),
        ("royalties da mineração", None), ("regalías", ["minería", "petróleo"]),
        ("cobrança", ["royalties", "mineração"]), ("矿产权利金", None),
    ],
}
...
def run(dry_run=False, fixtures=None):
    ...
    for src, raw in results:
        ...
        if raw:
            ...
            for row in parse_feed(raw, src):
                ...
                # No silent default. This read `or ["ground"]`, which filed 292
                # of 821 stories under a subject none of them had matched.
    ...
    if dry_run:
        print("\n--dry-run: wire_resource.json not written")
        return payload
